(Download/ View the raw readme file(readme) to read the things properly because without download here it looks a bit messy)
...
To design and develop this intelligent system using historical loan application data. The system must learn hidden patterns from previous customer records and provide accurate, fast, and unbiased loan approval decisions.
